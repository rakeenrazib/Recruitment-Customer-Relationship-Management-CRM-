<x-guest-layout>
    <div class="panel mx-auto w-full max-w-xl p-8 sm:p-10">
        ...
        <h1 class="mt-3 font-display text-4xl font-black text-slate-950">Choose a fresh password</h1>
        <p class="mt-4 text-sm leading-6 text-slate-500">Use a strong password you have not used elsewhere to protect your account.</p>
